...
const CARD_TEMPLATE_ID = "cardTemplate";

/* Other values*/
const TODAYS_CARD_TITLE = "TODAY";
const PAST_ITEMS_CARD_TITLE = "UNFINISHED BUSINESS";
const TASKS_EVER_COMPLETED_TITLE = "TASKS EVER COMPLETED";
